...
import corgitaco.blockdestroyspeedtweaker.Constants;
...
public class ForgeNetworkHandler {
    ...
    public static void init() {
        ...
        SIMPLE_CHANNEL.registerMessage(0, ConfigSyncPacket.class, ConfigSyncPacket::write, ConfigSyncPacket::readFromPacket, ForgeNetworkHandler::handle);
